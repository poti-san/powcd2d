...
DWRITE_GLYPH_RUN._fields_ = (
    ...
    ("glyph_offsets", POINTER(DWRITE_GLYPH_OFFSET)),
    ("is_sideways", c_int32),
    ("bidi_level", c_uint32),
)
...
IDWriteTextFormat._methods_ = [
    ...
    STDMETHOD(c_int32, "SetTrimming", (POINTER(DWRITE_TRIMMING), POINTER(IDWriteInlineObject))),
...
IDWriteTypography._methods_ = [
    STDMETHOD(c_int32, "AddFontFeature", (DWRITE_FONT_FEATURE,)),
    STDMETHOD(c_uint32, "GetFontFeatureCount", ()),
    STDMETHOD(c_int32, "GetFontFeature", (c_uint32, POINTER(DWRITE_FONT_FEATURE))),
]
...
IDWriteTextAnalysisSink._methods_ = [
    STDMETHOD(c_int32, "SetScriptAnalysis", (c_uint32, c_uint32, POINTER(DWRITE_SCRIPT_ANALYSIS))),
    STDMETHOD(c_int32, "SetLineBreakpoints", (c_uint32, c_uint32, POINTER(DWRITE_LINE_BREAKPOINT))),
...
IDWriteInlineObject._methods_ = [
    ...
    STDMETHOD(c_int32, "GetMetrics", (POINTER(DWRITE_INLINE_OBJECT_METRICS),)),
    STDMETHOD(c_int32, "GetOverhangMetrics", (POINTER(DWRITE_OVERHANG_METRICS),)),
...
IDWritePixelSnapping._methods_ = [
    ...
    STDMETHOD(c_int32, "GetcurrentTransform", (c_void_p, POINTER(DWRITE_MATRIX))),
...
IDWriteTextRenderer._methods_ = [
    *IDWritePixelSnapping._methods_,
    ...
    STDMETHOD(c_int32, "DrawUnderline", (c_void_p, c_float, c_float, POINTER(DWRITE_UNDERLINE), POINTER(IUnknown))),
    STDMETHOD(
        c_int32, "DrawStrikethrough", (c_void_p, c_float, c_float, POINTER(DWRITE_STRIKETHROUGH), POINTER(IUnknown))
    ),
    STDMETHOD(
        c_int32,
        "DrawInlineObject",
...
IDWriteTextLayout._methods_ = [
    *IDWriteTextFormat._methods_,
    ...
    STDMETHOD(c_int32, "SetFontCollection", (POINTER(IDWriteFontCollection), DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetFontFamilyName", (c_wchar_p, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetFontWeight", (c_int32, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetFontStyle", (c_int32, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetFontStretch", (c_int32, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetFontSize", (c_float, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetUnderline", (c_int32, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetStrilethrough", (c_int32, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetDrawingEffect", (POINTER(IUnknown), DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetInlineObject", (POINTER(IDWriteInlineObject), DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetTypography", (POINTER(IDWriteTypography), DWRITE_TEXT_RANGE)),
    STDMETHOD(c_int32, "SetLocaleName", (c_wchar_p, DWRITE_TEXT_RANGE)),
    STDMETHOD(c_float, "GetMaxWidth", ()),
    STDMETHOD(c_float, "GetMaxHeight", ()),
    STDMETHOD(c_int32, "GetFontCollection", (c_uint32, POINTER(IDWriteFontCollection), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontFamilyNameLength", (c_uint32, POINTER(c_uint32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontFamilyName", (c_uint32, c_void_p, c_uint32, POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontWeight", (c_uint32, POINTER(c_uint32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontStyle", (c_uint32, POINTER(c_int32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontStretch", (c_uint32, POINTER(c_int32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetFontSize", (c_uint32, POINTER(c_float), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetUnderline", (c_uint32, POINTER(c_int32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetStrikethrough", (c_uint32, POINTER(c_int32), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetDeawingEffect", (c_uint32, POINTER(POINTER(IUnknown)), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(
        c_int32, "GetInlineObject", (c_uint32, POINTER(POINTER(IDWriteInlineObject)), POINTER(DWRITE_TEXT_RANGE))
    ),
    STDMETHOD(c_int32, "GetTypography", (c_uint32, POINTER(POINTER(IDWriteTypography)), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetLocaleNameLength", (c_uint32, POINTER(POINTER(c_uint32)), POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "GetLocaleName", (c_void_p, c_uint32, POINTER(DWRITE_TEXT_RANGE))),
    STDMETHOD(c_int32, "Draw", (c_void_p, POINTER(IDWriteTextRenderer), c_float, c_float)),
    STDMETHOD(c_int32, "GetLineMetrics", (POINTER(DWRITE_LINE_METRICS), c_uint32, POINTER(c_uint32))),
    STDMETHOD(c_int32, "GetMetrics", (POINTER(DWRITE_TEXT_METRICS),)),
    STDMETHOD(c_int32, "GetOverhangMetrics", (POINTER(DWRITE_OVERHANG_METRICS),)),
    STDMETHOD(c_int32, "GetClusterMetrics", (POINTER(DWRITE_CLUSTER_METRICS), c_uint32, POINTER(c_uint32))),
    STDMETHOD(c_int32, "DetermineMinWidth", (POINTER(c_float),)),
    STDMETHOD(
        c_int32,
        "HitTestPoint",
        (c_float, c_float, POINTER(c_int32), POINTER(c_int32), POINTER(DWRITE_HIT_TEST_METRICS)),
    ),
    STDMETHOD(
        c_int32,
        "HitTestTextPosition",
        (c_uint32, c_int32, POINTER(c_float), POINTER(c_float), POINTER(DWRITE_HIT_TEST_METRICS)),
    ),
    STDMETHOD(
        c_int32,
        "HitTestTextRange",
        (c_uint32, c_uint32, c_float, c_float, POINTER(DWRITE_HIT_TEST_METRICS), c_uint32, POINTER(c_uint32)),
    ),
]
